...
imagefilledrectangle($im,$margin-10-1.5,0.25*$margin-1.5,$margin-10+1.5,0.25*$margin+1.5,$blue);
imagefilledrectangle($im,$margin+30-1.5,0.25*$margin-1.5,$margin+30+1.5,0.25*$margin+1.5,$green);
$a4=explode(",",$allele);
imagestring($im,5,$margin-40,0.25*$margin-7.5,$a4[1].$a4[1],$black);
imagestring($im,5,$margin,0.25*$margin-7.5,$a4[0].$a4[1],$black);
imagestring($im,5,$margin+40,0.25*$margin-7.5,$a4[0].$a4[0],$black);
///////////////make scales///////////////
